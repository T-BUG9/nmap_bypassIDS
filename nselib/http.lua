...
USER_AGENT = stdnse.get_script_args('http.useragent') or "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 Safari/537.36"
...
function identify_404(host, port)
  ...
  local URL_404_1 = '/Microlowercheck' .. os.time(os.date('*t'))
  local URL_404_2 = '/MicroUpperCheck' .. os.time(os.date('*t'))
  local URL_404_3 = '/Micro/folder/check' .. os.time(os.date('*t'))
